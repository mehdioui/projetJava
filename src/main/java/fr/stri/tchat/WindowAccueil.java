...
public class WindowAccueil extends javax.swing.JFrame {
    ...
    /**
     * Creates new form WindowAccueil
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WindowAccueil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WindowAccueil().setVisible(true);
            }
        });
    }
